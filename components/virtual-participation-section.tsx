...
export function VirtualParticipationSection() {
  return (
    <section className="relative overflow-hidden border-t border-black/5 bg-white py-16 text-black sm:py-24 md:py-32">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-3xl rounded-2xl border border-black/10 bg-white p-6 text-center shadow-lg shadow-black/[0.03] sm:rounded-3xl sm:p-10 md:p-12">
          <h2 className="font-instrument text-3xl font-medium leading-tight text-black sm:text-4xl md:text-5xl">
