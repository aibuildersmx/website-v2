...
/**
 * Checkmark-prefixed bullet list rendered inside a subtle box.
 *
 * Use for "what's included", "benefits", or "features" lists where the
 * visual ✓ reinforces the positive signal. When you just need a normal
 * bulleted list, prefer plain markdown `-`.
 *
 * Example:
 * ```mdx
 * <CheckList items={[
 *   { title: 'Búsqueda web', description: 'Para investigar automáticamente' },
...
export function CheckList({ items }: { items: CheckListItem[] }) {
    ...
    return (
        <div
            className={cn(
                'rounded-xl border p-5 sm:p-6 my-6',
