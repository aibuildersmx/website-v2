...
export const HeroHeader = () => {
    ...
    return (
        <header className="fixed top-6 inset-x-0 z-[100] flex justify-center pointer-events-none px-6">
            <nav className={cn(
                "pointer-events-auto flex items-center justify-between p-2 rounded-full border transition-all duration-500 ease-in-out w-full max-w-6xl",
                scrolled 
                ...
                <Link
                    href="/"
                    aria-label="home"
                    className="flex items-center justify-center h-10 px-2 rounded-full hover:bg-white/10 transition-colors"
                >
                    <img 
