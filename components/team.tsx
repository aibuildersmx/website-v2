...
export default function TeamSection() {
  return (
    <section
      className="py-16 sm:py-24 md:py-32 bg-white text-black border-t border-black/5"
      id="team"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-8 sm:mb-12 md:mb-16 text-center">
          <span className="text-[10px] sm:text-xs font-mono uppercase tracking-widest text-black/40 font-medium">
            Hecho por
          </span>
          <h2 className="mt-3 text-2xl sm:text-3xl md:text-4xl font-instrument font-medium">
            El equipo detrás de AI Builders
          </h2>
        </div>
        <div className="grid gap-3 sm:gap-4 md:gap-8 md:grid-cols-3">
          {members.map((member, index) => (
            ...
            >
              ...
              <div className="p-3 sm:p-5 md:p-6 flex flex-col flex-1 min-w-0">
                <div className="flex justify-between items-start mb-1 sm:mb-2 md:mb-4">
                  <h3 className="text-lg sm:text-2xl md:text-2xl font-instrument font-medium leading-tight truncate">
                    {member.name}
                  </h3>
                ...
                <div className="mt-auto flex items-center justify-between">
                  <span className="text-[9px] sm:text-[10px] md:text-xs font-mono text-black/40 uppercase tracking-widest font-medium">
                    {member.role}
                  </span>
